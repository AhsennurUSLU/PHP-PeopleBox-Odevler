<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(empty($input_title)){
            $description_err   = "<div class='alert alert-danger mb-0 text-center'>title boş geçilemez.</div>";
            echo  $description_err ;
            //$title_err = "title boş geçilemez.";
        }else if(strlen($input_title) > 150){
            $description_err   = "<div class='alert alert-danger mb-0 text-center'>title için çok fazla karakter kullandınız. Max: 150kr</div>";
            echo  $description_err ;
        ...
        if(empty($input_description)){
           ...
           // $description_err = "title boş geçilemez.";
            ...
            $description_err   = "<div class='alert alert-danger mb-0 text-center'>description için çok az karakter kullandınız. Min: 11kr</div>";
            echo  $description_err ;
        ...
        if(empty($title_err) && empty($description_err)){
            if( createBlog($title,$description,$image,$url)){
                ...
                echo "<div class='alert alert-danger mb-0 text-center'>Yükleme sırasında hata oluştu</div>";
            }
        }  
    }
?>
