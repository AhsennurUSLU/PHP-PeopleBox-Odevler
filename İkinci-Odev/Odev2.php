                ...
                <?php foreach ($filmler as $id => $film) : ?>
                    ...
                    <div>
                        ...
                        <?php if ($film["yorumSayisi"] > 0) : ?>
                            <?php echo '<span class="badge bg-success"> ' . $film["yorumSayisi"] . ' yorum </span>';
                        ...
                        <?php if ($film["vizyon"]) : ?>
                            <?php echo '<span class="badge bg-success">' . "vizyonda" .  '</span>'; ?>
                        <?php else : ?>
                            <?php echo  '<span class="badge bg-success">' . "vizyonda değil" .  '</span>'; ?>
